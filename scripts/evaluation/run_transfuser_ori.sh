...
# python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_pdm_score_with_render_edit_multi_agent.py \
...
# python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_pdm_score_with_render_edit_newpdm.py \
# train_test_split=$TRAIN_TEST_SPLIT \
# agent=transfuser_agent \
# worker=single_machine_thread_pool \
# agent.checkpoint_path=$CHECKPOINT \
# experiment_name=transfuser_agent_eval 
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_pdm_score_with_render_multi_agent_newpdm.py \
train_test_split=$TRAIN_TEST_SPLIT \
agent=transfuser_agent \
worker=single_machine_thread_pool \
agent.checkpoint_path=$CHECKPOINT \
