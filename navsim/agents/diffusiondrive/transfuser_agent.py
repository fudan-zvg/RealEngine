...
class TransfuserAgent(AbstractAgent):
    ...
    def name(self) -> str:
        ...
        return 'DiffusionDriveAgent'  # self.__class__.__name__
    ...
    def compute_trajectory(self, agent_input: AgentInput, multi_traj=False) -> tuple[Trajectory, torch.Tensor, torch.Tensor]:
        """
        ...
        # extract trajectory
        if multi_traj:
            return Trajectory(poses), predictions["poses_cls"], predictions["poses_reg"]
        else:
