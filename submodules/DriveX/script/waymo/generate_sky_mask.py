...
if __name__ == "__main__":
    ...
    parser.add_argument('--datadir', type=str, default='./data/waymo/streetgs_format/training')
    ...
    seqs = os.listdir(args.datadir)
    for seq in seqs:
        datadir = os.path.join(args.datadir, seq)
        if os.path.exists(os.path.join(datadir, 'sky_mask')):
            continue
