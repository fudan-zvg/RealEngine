...
import random
import json
from submodules.DriveX.lib.utils.camera_utils import camera_to_JSON, cameraList_from_camInfos
# from submodules.DriveX.lib.config import cfg
from submodules.DriveX.lib.datasets.base_readers import storePly, SceneInfo
from submodules.DriveX.lib.datasets.colmap_readers import readColmapSceneInfo
from submodules.DriveX.lib.datasets.blender_readers import readNerfSyntheticInfo
from submodules.DriveX.lib.datasets.waymo_full_readers import readWaymoFullInfo
from submodules.DriveX.lib.datasets.nuplan_readers import readNuplanInfo
...
class Dataset:
    def __init__(self, cfg):
        ...
        scene_info: SceneInfo = sceneLoadTypeCallbacks[dataset_type](self.source_path, cfg, **cfg.data)
