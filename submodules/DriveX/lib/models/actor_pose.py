...
import numpy as np
from submodules.DriveX.lib.utils.general_utils import quaternion_raw_multiply, get_expon_lr_func, quaternion_slerp, matrix_to_quaternion
...
class ActorPose(nn.Module):
    ...
    def find_closest_indices(self, track_id, timestamp):
        ...
        try:
            ...
            print("Error in find_closest_indices for track_id:", track_id)
