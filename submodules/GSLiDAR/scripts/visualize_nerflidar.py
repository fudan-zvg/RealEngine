...
path = "../lidar-nerf/log/kitti360_lidar/1538/validation/lidar_nerf_ep0500_0003_lidar.npy"
lidar = np.load(path)
...
save_ply(torch.from_numpy(points), 'nerflidar.ply', torch.from_numpy(color))
...
# # plt.show()
#
# plt.savefig('nerflidar.pdf', format='pdf', bbox_inches='tight')
